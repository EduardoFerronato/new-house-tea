const { findPresenteById, updatePresente, initFirebase } = require('../firebase-helper');
...
module.exports = async (req, res) => {
    ...
    try {
        ...
        const presenteAtualizado = await findPresenteById(idNum);
